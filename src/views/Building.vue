          ...
          <div id="basicCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="300000">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="@/assets/img/building/001.png" class="d-block w-100" alt="圖片1">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/002.png" class="d-block w-100" alt="圖片2">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/003.png" class="d-block w-100" alt="圖片3">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/004.png" class="d-block w-100" alt="圖片4">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/005.png" class="d-block w-100" alt="圖片5">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/006.png" class="d-block w-100" alt="圖片6">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/007.png" class="d-block w-100" alt="圖片7">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/008.png" class="d-block w-100" alt="圖片8">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/009.png" class="d-block w-100" alt="圖片9">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/010.png" class="d-block w-100" alt="圖片10">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/011.png" class="d-block w-100" alt="圖片11">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/building/012.png" class="d-block w-100" alt="圖片12">
              </div>
            </div>
