          ...
          <div id="basicCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="300000">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="@/assets/img/about/001.png" class="d-block w-100" alt="圖片1">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/about/002.png" class="d-block w-100" alt="圖片2">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/about/003.png" class="d-block w-100" alt="圖片3">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/about/004.png" class="d-block w-100" alt="圖片4">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/about/005.png" class="d-block w-100" alt="圖片5">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/about/006.png" class="d-block w-100" alt="圖片6">
              </div>
            </div>
