          ...
          <div id="basicCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="300000">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="@/assets/img/floorplan/016.png" class="d-block w-100" alt="">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/floorplan/017.png" class="d-block w-100" alt="">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/floorplan/018.png" class="d-block w-100" alt="">
              </div>
              <div class="carousel-item">
                <img src="@/assets/img/floorplan/019.png" class="d-block w-100" alt="">
              </div>
